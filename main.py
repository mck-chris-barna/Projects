...
file_path = "/Users/cbarna/Downloads/Mike Scrap - Sheet7 (1).csv"
...
# Load the CSV and run sentiment analysis
...
df.to_csv(f"outputs/{output_path}")
...
def histo():
    ...
    print(f"Plot saved at: {os.path.abspath('plot.png')}")
